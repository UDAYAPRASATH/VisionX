...
import { compareScreenshotsWithGroqLlava } from './grokClient';
import { highlightDiff } from './highlight_diff';

const urls = JSON.parse(fs.readFileSync('urls.json', 'utf-8'));
const GROK_API_KEY = process.env.GROQ_API_KEY || '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';
